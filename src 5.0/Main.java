...
public class Main {
    ...
    // método que verifica se o e-mail está de acordo com os requisitos citados no
    // print na hora do cadastro de usuario
    private static String verificaEmail() {
        ...
        do {
            System.out.println("Ele precisa conter pelo menos 4 caracteres antes do @, o @ e precisa ser hotmail.com");
    ...
    // método que verifica se a senha está de acordo com os requisitos citados no
    // print na hora do cadastro de usuario
    public static String verificaSenha() {
        String senha;
        Scanner leSenha = new Scanner(System.in);
        do {
            System.out.println("A senha deve conter pelo menos 8 caracteres e conter @ ou & ou %");
    ...
    // verifica o primeiro índica vazio do vetor de usuario. Usado para salvar o
    // usuário na hora de criar o cadastro
    ...
    private static void cadastraUsuario() {
        ...
        do {
            System.out.println("Digite sua idade (Precisa ser maior que 18 anos):");
    ...
    // metodo que retorna o nome do usuário que está logado. É chamado toda vez que
    // alguém faz loggin.
    // É o que garante que somente as movimentações e o saldo relacionado ao usuario
    // logado serão alterados durante as operações no menu
    ...
    // metodo que procura o email no vetor usuario na hora do loggin
    ...
    // metodo que procura a senha no vetor usuario na hora do loggin
    ...
    // metodo que atualiza o saldo diretamente atraves da opçao 1 do menu
    ...
    // metodo utilizado para descontar ou aumentar o saldo. Chamado atraves da opçao
    // de cadastrar movimentação no menu
    // desconta ou aumenta o saldo baseado na categoria escolhida (se é receita ou
    // despesa)
    ...
    // menu do usuário logado. Só é chamado depois que o usuario efetuar o loggin
    ...
    // Exibe o menu de cadastro ou loggin
    ...
    public static void cadastrarCategoria(Scanner entrada) {
        ...
        categorias[qtdCategorias] = new Categoria(qtdCategorias, nome, tipo);
    ...
    // Lista todas as movimentações do usuário logado
